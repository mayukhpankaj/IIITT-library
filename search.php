  ...
  <hr>
   ...
   <form action="search.php" method="POST">
       <div1>
        ...
        <input type="text" name="query" maxlength="9" size="9"  required />
        <input type="submit" value="Search" name="srch"></div1>
    </form>
    
    <br> 
    <div1>
    search by: <a href="searchstudname.php">student name</a> &nbsp; <a href="searchbook.php">book name</a> &nbsp; <a href="searchbookid.php">book id</a>
    </div1>
   </div>
...
include('finevariable.php');
 ...
 {
     $sql = "SELECT bookid, bookname, studname, studroll, reg_date, ret_date, ret FROM reg  WHERE (`studroll` LIKE '%".$query."%')";
    ...
    while($row = mysqli_fetch_assoc($result)) 
      {
       ...
       $nr=$n-$ctr;
       echo "<br><h4>  &nbsp; &nbsp;".$n." records found ".$ctr." books issued ".$nr." books returned by ".$query."</h4><br>";
    }
   else
     {
