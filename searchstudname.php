...
<body>
 ...
 <div class="header">
  ...
  <hr>
   ...
   <form action="searchstudname.php" method="POST">
       <div1>
      ...
      <br> 
    <div1>
    search by: <a href="search.php">student roll</a> &nbsp; <a href="searchbook.php">book name</a> &nbsp; <a href="searchbookid.php">book id</a>
    </div1>
...
include('finevariable.php');
 ...
 {
     $sql = "SELECT bookid, bookname, studname, studroll, reg_date, ret_date, ret FROM reg  WHERE (`studname` LIKE '%".$query."%')";
