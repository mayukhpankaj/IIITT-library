...
<body>
  ...
  <h3> &nbsp; &nbsp;Indian Institue of Information Technology Tiruchirappalli, Library</h3>
   ...
   <form action="return.php" method="POST">
       <div1>
       <label>Roll no.</label>&nbsp;<input type="text" name="query" maxlength="9" required>
        <input type="submit" value="Search" name="search" ></div1><br>
    <div1><label>Book no</label>&nbsp;<input type="text" name="bookno" />
    <input type="submit" value="de issue" name="retb"></div1>
    </form>
   </div>
...
if(isset($_POST['retb']))
{
    ...
    $sql = "UPDATE reg SET ret_date=now(), ret=true WHERE bookid=$book";
