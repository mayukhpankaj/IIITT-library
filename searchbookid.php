...
<body>
 ...
 <div class="header">
  ...
  <hr>
   ...
   <form action="searchbookid.php" method="POST">
       <div1>
        <label>book id</label>
       ...
       <br> 
    <div1>
    search by: <a href="searchstudname.php">student name</a> &nbsp; <a href="search.php">student roll</a> &nbsp; <a href="searchbook.php">book name</a>
    </div1>
...
include('finevariable.php');
 ...
 {
     $sql = "SELECT bookid, bookname, studname, studroll, reg_date, ret_date, ret FROM reg  WHERE (`bookid` LIKE '%".$query."%')";
